...
app.get('/AnassMap', (req, res) => {
    ...
    app.post('/save', (req, res) => {
        let data = { id: req.body.id, nom: req.body.nom , latitude: req.body.latitude, longitude: req.body.longitude};
    ...
    app.post('/update', (req, res) => {
        ...
        let sql = "update etudiant SET id='" + req.body.id + "',  nom='" + req.body.nom + "',  latitude='" + req.body.latitude + "',  longitude='" + req.body.longitude +"' where id =" + Id;
